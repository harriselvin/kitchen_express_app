...
/**
 * A handler that fires when a user stops dragging an order.
 * It moves the order to a different column and updates the HTML.
 * @param {Event} event 
 */
...
/**
 * A handler that fires when a user clicks on the "?" button and 
...
/**
 * A handler that fires when a user clicks on the "Add Order" button and
...
/**
 * This handler fires when a user submits the order.
 * It extracts the data entered in the form, then creates an order data object,
 * it then updates the state with the new order data, then creates an HTML element for
 * the new order, and appends the HTML element.
 * The .value is used to access the 'title' and 'table' input.
 * @param {Event} event 
 */
...
/**
 * This handler fires when a user clicks on an order (that was already created).
 * @param {Event} event 
 */
...
/**
 * This handler fires when a user submits the "Edit Order".
...
/**
 * A handler that fires when a user clicks "delete" on
 * the "Edit Order" form.
